...
import CentralLoader from "../../components/CentralLoader.jsx";
...
const Signup = () => {
    ...
    const {userResponse, loading} = useSelector(state => state.account);
    ...
    useEffect(() => {
        if (userResponse?.status === true) {
            navigateUser("/login");
            showToast(userResponse?.message, "error")
        } else showToast(userResponse?.message, "error");
    }, [userResponse])
